...
export function recalculateMegatrendMetrics(megatrendId: string): void {
  ...
  // Read current confirmation_status — confirmed_shift is protected by deriveConfirmationStatus
