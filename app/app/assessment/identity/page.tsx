...
import { IDENTITY_STORAGE_KEY, type IdentityAnswers } from '@/lib/assessment'

const EMPTY: IdentityAnswers = {
...
export default function IdentityPage() {
  ...
  const [answers, setAnswers] = useState<IdentityAnswers>(EMPTY)
